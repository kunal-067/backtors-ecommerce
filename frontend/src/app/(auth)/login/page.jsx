...
function Login() {
    return (
        <div className='shadow-xl p-10 rounded-xl w-[498px] h-[547px]'>
            ...
            <p className='opacity-50 text-[14px] font-[400]'>Welcome back !!</p>
            <h2 className='text-[56px] font-bold mb-4'>Sign In</h2>
            ...
            <div className='flex flex-col w-full justify-center items-center gap-4 mt-10'>
                ...
                <p>
                    ...
                    <span className='text-[#F47458] ml-2'><a href="#">Sign Up</a></span>
                </p>
            </div>
        </div>
    )
